...
void myData()
{
	float vertices[] = 
	{
		...
		-0.13857f,	0.67195f,	0.0f,	0.8f, 0.2f, 0.2f,//J #7
		-0.06724f,	0.63397f,	0.0f,	0.8f, 0.2f, 0.2f,//K #8
		-0.10985f,	0.55431f,	0.0f,	0.8f, 0.2f, 0.2f,//L #9
		-0.22472f,	0.44408f,	0.0f,	0.8f, 0.2f, 0.2f,//M #10
		-0.42666f,	0.39313f,	0.0f,	0.8f, 0.2f, 0.2f,//N #11
		-0.36552f,	0.45102f,	0.0f,	0.8f, 0.2f, 0.2f,//O #12
		-0.36135f,	0.56774f,	0.0f,	0.8f, 0.2f, 0.2f,//P #13
		-0.00855f,	0.45199f,	0.0f,	0.8f, 0.2f, 0.2f,//Q #14
		...
		// positions         //
		-0.41291f,	0.67084f,	0.0f,//C
		-0.36279f,	0.70685f,	0.0f,//D
		-0.29224f,	0.64895f,	0.0f,//E
		-0.26888f,	0.55844f,	0.0f,//F
		-0.20417f,	0.64846f,	0.0f,//G
		-0.29141f,	0.7757f,	0.0f,//H
		-0.20249f,	0.84471f,	0.0f,//I
		-0.13857f,	0.67195f,	0.0f,//J
		-0.06724f,	0.63397f,	0.0f,//K
		-0.10985f,	0.55431f,	0.0f,//L
		-0.22472f,	0.44408f,	0.0f,//M
		-0.42666f,	0.39313f,	0.0f,//N
		-0.36552f,	0.45102f,	0.0f,//O
		-0.36135f,	0.56774f,	0.0f,//P
		-0.00855f,	0.45199f,	0.0f,//Q
		0.05791f,	0.40693f,	0.0f,//R
		0.11596f,	0.3061f,	0.0f,//S
		-0.0421f,	0.35741f,	0.0f,//T
		0.0f,		0.3f,		0.0f,//U
		-0.0103f,	0.25517f,	0.0f,//V
		-0.06823f,	0.30629f,	0.0f,//W
		-0.49763f,	0.155199f,	0.0f,//A
		0.05218f,	0.15634f,	0.0f,//B
		-0.17161f,	0.05182f,	0.0f,//C
		0.29849f,	-0.08113f,	0.0f,//D
		0.0f,		0.0f,		0.0f,//E
		-0.00132f,	-0.22054f,	0.0f,//F
		-0.36225f,	-0.22114f,	0.0f,//G
		-0.20641f,	-0.22114f,	0.0f,//H
		-0.13866f,	-0.46912f,	0.0f,//I
		-0.2f,		-0.4f,		0.0f,//J
		-0.27959f,	-0.38782f,	0.0f,//K
		-0.20506f,	-0.52468f,	0.0f,//L
		-0.38122f,	-0.75775f,	0.0f,//M
		-0.4571f,	-0.78078f,	0.0f,//N
		-0.49233f,	-0.84311f,	0.0f,//O
		-0.34463f,	-0.84176f,	0.0f,//P
		-0.14544f,	-0.6114f,	0.0f,//Q
		0.05376f,	-0.5572f,	0.0f,//R
		-0.06549f,	-0.76046f,	0.0f,//S
		-0.15899f,	-0.76317f,	0.0f,//T
		-0.2037f,	-0.84176f,	0.0f,//U
		0.1905f,	-0.84355f,	0.0f,//V
		0.42498f,	-0.58516f,	0.0f,//W
		0.33667f,	-0.44434f,	0.0f,//Z
		0.468f,		-0.41177f,	0.0f,//A
		0.51649f,	-0.61202f,	0.0f,//B
		0.59784f,	-0.7137f,	0.0f,//C
		0.83786f,	-0.5516f,	0.0f,//D
		0.76254f,	-0.35123f,	0.0f,//E
		0.9146f,	-0.32991f,	0.0f,//F
		0.77959f,	-0.21764f,	0.0f,//G
		0.80375f,	-0.0798f,	0.0f,//H
	};
